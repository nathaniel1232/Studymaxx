...
export function useTranslation() {
  ...
  return (key: string, variables?: Record<string, string>): string => {
    const translations: Record<string, Record<Language, string>> = {
      ...
      "paste_or_type_text": { en: "Paste or type text", no: "Lim inn eller skriv tekst" },
      "upload_docx_file": { en: "Upload .docx file", no: "Last opp .docx-fil" },
      "upload_image_file": { en: "Upload Image", no: "Last opp bilde" },
      "difficulty_level": { en: "Difficulty Level", no: "Vanskelighetsgrad" },
      "number_of_flashcards": { en: "Number of Flashcards", no: "Antall Kunnskapskort" },
      ...
      "upload_notes": { en: "Create smart flashcards instantly from your study material.", no: "Lag smarte kunnskapskort umiddelbart fra studiematerialet ditt." },
      ...
      "upload_pdf_docs": { en: "Get all current and upcoming premium features", no: "Få alle nåværende og kommende premium-funksjoner" },
      "youtube_support": { en: "Priority AI", no: "Prioritert AI" },
      "learn_from_videos": { en: "Faster generation and higher quality cards", no: "Raskere generering og høyere kvalitet på kort" },
